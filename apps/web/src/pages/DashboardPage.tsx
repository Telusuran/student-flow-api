        ...
        <div className="flex-1 min-h-full py-10 px-20 flex flex-col items-start gap-8 relative overflow-hidden">
            ...
            <div className="w-full max-w-6xl flex flex-col gap-8 z-10">
                ...
                <div className="w-full flex flex-col justify-start items-start">
                    <div className="w-full p-6 relative bg-sidebar-blue shadow-soft overflow-hidden rounded-2xl border border-white flex flex-col justify-start items-start">
                        {/* Decorative Circle */}
                ...
                <div className="w-full min-h-[375px] flex justify-center items-start gap-6">
                    ...
                    {/* Active Projects */}
                    <div className="w-1/3 h-full self-stretch bg-sidebar-blue shadow-soft overflow-hidden rounded-2xl border border-white flex flex-col gap-0 hover:translate-y-[-2px] transition-transform duration-300">
                        <div className="w-full py-5 px-6 bg-white/30 border-b border-secondary-accent/10 backdrop-blur-sm flex justify-between items-center">
                            <h3 className="text-text-dark-blue text-lg font-bold leading-7 font-display">Active Projects</h3>
                            <div className="flex gap-3">
                                <button className="text-[#E6B325] text-sm font-semibold leading-5 font-display hover:underline">+ New Project</button>
                                <button className="text-text-muted text-sm font-semibold leading-5 font-display hover:text-text-main">View All</button>
                            </div>
                        </div>
                        <div className="w-full p-2 flex flex-col">
                            {/* Project Item */}
                            <div className="w-full p-4 rounded-xl flex items-center gap-4 hover:bg-white/40 transition-colors cursor-pointer">
                    ...
                    <div className="w-1/3 h-full self-stretch bg-sidebar-blue shadow-soft overflow-hidden rounded-2xl border border-white flex flex-col gap-0 hover:translate-y-[-2px] transition-transform duration-300">
                        ...
                        <div className="w-full p-4 flex flex-col">
                            {/* Deadline Item */}
                            <div className="w-full p-4 bg-white shadow-sm overflow-hidden rounded-r-xl border-l-[3px] border-l-[#E6B325] flex items-start gap-4">
                    ...
                    <div className="w-1/3 h-full self-stretch relative bg-black shadow-soft overflow-hidden rounded-2xl border border-white/50 flex flex-col gap-0 hover:translate-y-[-2px] transition-transform duration-300 group">
                        ...
                        <div className="w-full py-5 px-6 border-b border-white/20 flex justify-between items-center z-10">
                            ...
                            <div className="py-1 px-3 bg-white/20 rounded-full flex justify-center items-start">
                                <span className="text-white text-xs font-medium leading-4 font-display mr-1">1 min</span>
                            </div>
                        </div>

                        <div className="flex-1 relative w-full z-10 flex flex-col items-center justify-center pt-6 pb-2">
                            {/* Sun/Timer Graphic */}
                            <div className="w-32 h-32 relative flex justify-center items-center mb-8 group-hover:scale-105 transition-transform duration-500">
                                <div className="w-20 h-20 bg-[#FFD700] shadow-[0_0_40px_rgba(255,215,0,0.6)] rounded-full flex justify-center items-center z-20 animate-pulse">
                                ...
                                <div className="absolute inset-0 opacity-60">
                                    <div className="absolute left-[6px] top-0 w-[115px] h-[115px] bg-[#FFD700] rounded-full blur-md animate-spin-slow"></div>
                                </div>
                            </div>

                            <div className="flex flex-col items-center gap-1 mb-6">
                                <h3 className="text-center text-white text-lg font-bold leading-7 font-display">Ready to relax?</h3>
                                <p className="text-center text-white/80 text-sm font-normal leading-5 font-display">Take a moment to center yourself.</p>
                            </div>

                            <button className="px-6 py-2 bg-white shadow-lg rounded-xl flex justify-center items-center hover:bg-gray-50 transition-colors">
                                <span className="text-orange-600 text-sm font-bold leading-5 font-display">Start</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full pb-8 flex justify-start items-start gap-4">
                    {[
                        { icon: 'task', label: 'Add Task', color: '#1E293B' },
                        { icon: 'upload_file', label: 'Upload File', color: '#1E293B' },
                        { icon: 'group_add', label: 'Join Group', color: '#1E293B' },
                        { icon: 'calendar_add_on', label: 'Book Slot', color: '#1E293B' }
                    ].map((action, index) => (
                        <div key={index} className="flex-1 py-4 px-20 bg-sidebar-blue shadow-soft overflow-hidden rounded-2xl border border-white flex flex-col justify-center items-center gap-2 hover:bg-blue-300/50 transition-colors cursor-pointer group">
